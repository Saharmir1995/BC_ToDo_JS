...
function LightToDark() {
    ...
    document.querySelector(".LBack-ground").style.backgroundImage = "url(\"../bg-desktop-dark.jpg\")"
...
function DarkToLight() {
    ...
    document.querySelector(".LBack-ground").style.backgroundImage = "url(\"../bg-desktop-light.jpg\")"
    ...
    return (`<div class="box1 theme">
                <div>
                    <div onclick="checked('${obj.name}')" class="circle">
                        <img src="../icon-check.svg" class="check" alt="check">
                    </div>
                </div>
                <div class="list theme">
                    <p class="theme paragraph">${obj.name}</p>
                    <img src="../icon-cross.svg" class="delete" onclick="remove('${obj.name}')" alt="trash">
                </div>
                </div>
    `)
}
